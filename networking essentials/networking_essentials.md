...
A private network connects to the Internet via a router that supports NAT. The router maintains a translation table for the ongoing connections.
...
**It is time to join Networking Core Protocols.**  
`No answer needed`
